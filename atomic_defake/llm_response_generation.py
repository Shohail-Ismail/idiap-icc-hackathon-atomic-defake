...
def generate_llm_responses(post, questions, client):
    ...
    for q in questions:
        ...
        qa_pairs.append({"question": q, "response_llm": {"response": evaluation_response['misinformation'], "certainty": evaluation_response['certainty'], "reason": evaluation_response['reason']}})
        print()
        time.sleep(1)
    return qa_pairs
